...
/mob/proc/ClickOn( atom/A, params )
	...
	if(modifiers["middle"])
		MiddleClickOn(A)
		return
	if(modifiers["shift"] && (client && client.show_popup_menus || (modifiers["right"] && modifiers["alt"]))) //CIT CHANGE - makes shift-click examine use right click instead of left click in combat mode
		ShiftClickOn(A)
		return
